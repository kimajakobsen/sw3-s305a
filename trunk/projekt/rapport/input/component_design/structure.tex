...
\begin{figure}[hbt]
	...
	\morscaption{The revised model component. Notice that the attributes of each class is omitted, these are however shown in the E-R diagram in figure \ref{fig:er_diagram}}
	\label{fig:modelComponent}
\end{figure}

The new classes are: \class{Comment}, \class{Tag}, \class{Category}, and \class{Admin}.
...
Comment simply holds a comment for a given problem, and remembers the poster of the \class{Comment}.
...
\input{input/component_design/er_diagram}