...
We considering using PostgreSQL, but using postgreSQL with C\# and Visual Studio required a plugin in order to use the ADO.NET Entity Data Model Designer. As a database vendor either choice would not give us any advantages on the data layer, since the functionality we require is supported by both systems. 