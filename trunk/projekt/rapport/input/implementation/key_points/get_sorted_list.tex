...
The \me{GetSortedList()} method purpose is to sort the staff members list of problems the way where the most important problems -- which are defined in section \ref{sec:problem_priority} -- are listed first. 
