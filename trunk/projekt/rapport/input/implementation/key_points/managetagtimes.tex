...
The \me{ManageTagTimes} method updates the properties \vari{SolvedProblems} and \vari{TimeConsumed} of the class \cl{tag}. By incrementing the \vari{SolvedProblems} and \vari{TimeConsumed} properties of each tag respectively by one and the time used for the problem to be solved. The method is shown in code snippet \ref{lst:managetagtimes}.
