...
The \me{Search} function is called with the parameters above.
It then calls an \me{InternalSearch} function which is private, with the same parameters and a compare function which determines how the problems should be sorted.
...
It does so by calling the \me{InternalSearch} function with another compare function.
