...
The report is split into five parts, \nameref{analysis}, \nameref{design}, \nameref{implementation}, \nameref{testing}, and \nameref{epilogue}. Each part consist of several chapters. In the top and bottom of every chapter there is a small piece of text written in italic. This marks the head and tail of each chapter. The head outlines the content and the reason for the chapter, whilst the tail summarizes the chapter.
...
We would like to give our thanks to Kristian Torp for help during setup of the database for our system and to Rene Hansen for helping us choose a framework to build our system upon.
