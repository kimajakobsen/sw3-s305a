...
In the process of finding classes and events we made up several classes and events some of which are not used in the actual program, since it might be more efficient to exclude some classes. This will be elaborated further in the \nameref{design} part. To come up with the classes and events we talked about different possible scenarios, we then developed our class diagram based upon these scenarios. This section describes all the classes and events in the final iteration of the process and all the redundant classes and events are omitted. On figure \ref{fig:classeseventstable} the relations between classes and events are illustrated.  
\fixme{Står i datid}
