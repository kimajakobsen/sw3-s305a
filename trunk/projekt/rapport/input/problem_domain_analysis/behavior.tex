...
In this section of the report, we will describe the behavior of the two major classes \class{Problem} and \class{Person}. These two are the only classes which can have more states. 
