...
\fixme{Skal der evt. sættes en kilde her eller er det verbotten i perspective}
...
The \hdesk[] is not only way to make a help desk, but just the result of our approach to it, which we have documented in this report.
\fixme{Lidt tynd afrunding her til sidst, men er kørt lidt død i det.
Måske top and tail skal droppes og skrives ud i texten i stedet?}
