...
The act is the run of the method and the assert is the actual testing, e.g. where the result from the method is compared to an expected value. \fixme{unit test referance her tak.} \fixme{Der findes ikke nogen...}
