...
\myTop{The test cases made for the \me{BalanceWorkload} method of the \cl{Department} class are described in this chapter. Thisis important to documant the 
...
\fixme{Der skal st\aa{} noget i starten om hvilken metode der er brugt til at give disse test cases liv.}
...
\fixme{Evt. alt source code i et appendix? SÂ kan vi henvise til det.}
