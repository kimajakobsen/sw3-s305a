...
The solve problem interface is used by the \astaff[] to perform his daily duties. This is the interface he will be using to get his \todolist{}, to communicate with the \aclient{} and to solve the problems. Since the \astaff{} often acts as \sadmin{} the button to go to the administration interface is presented at the main window of the \spinterface{}. But only the right full \astaff{} who knows the administrate password can access the administration interface. 
Beside entering the administrate interface the \astaff{} can get his \worklist{} and he can enter access the client main window, so he can act as both \aclient{} and \astaff{}. 
