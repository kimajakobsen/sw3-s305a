...
\subsubsection{Main}
The client interface is illustrated in figure \ref{Navigation_DiagramStaff.pdf}. After login the staff is presented with the ``Main'' staff window where the button ``Worklist'' is shown. When the ``Workslist'' button is press the window ``Worklist'' opens
