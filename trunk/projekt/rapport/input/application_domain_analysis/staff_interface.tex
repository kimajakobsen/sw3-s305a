...
After login, the \astaff[] is presented with the \textit{main} window. All the window have a back function whic enables the \astaff[] to return to the previous window.
