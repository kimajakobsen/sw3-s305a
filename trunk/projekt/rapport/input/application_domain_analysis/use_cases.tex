...
\item \sadb{Objects:} \cl{Problem, tag, comment, category, deadline, \aclient[], and \astaff[]}.
...
\item \sadb{Objects:}\cl{Problem, tag, comment, category, deadline, \aclient[], \astaff[], department, and solution}
