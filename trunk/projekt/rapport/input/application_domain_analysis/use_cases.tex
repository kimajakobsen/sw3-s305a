...
\item \sadb{Functions:} Search existing problems, compare problems, create problem, subscribe to problem. \fixme{fix saa det stemmer med funktions listen, naar den er blevet opdateret}
\end{itemize}
