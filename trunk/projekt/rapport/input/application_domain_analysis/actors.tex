\subsection{Actors}
The system has two primary actors \client and \staff. Beside these two the system has the two actors: \sadmin{} and the non-human actor \wmon. The \sadmin{} can be a regular \staff with more privileges or a manager. He can change the tags and categories, create departments and add \staff to the system. \wmon[] .      \rests hgfdsg f
