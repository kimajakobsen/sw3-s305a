...
\paragraph{Set permissions} sets the permissions of a specific person member. A \astaff[] member can either be allowed to administrate the system, such as add categories and tags, or not. 
