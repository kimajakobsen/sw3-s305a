...
%Reasign staff to department & Simple & Update \\ \hline%
...
\emph{Create Problem} simply creates a new problem and adds it to the database. Marked as a \textit{update}-function as it updates the model. \fixme{Hvorfor er "create problem" markeret som en compute-funktion?} \\
