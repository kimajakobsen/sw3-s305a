...
%\paragraph{Get tag average time consumption of a tag }
...
\paragraph{Reset persons password}
...
\paragraph{Add Person} A person can either be a \aclient[], \astaff[], or an \admin[]. See figure \ref{tab:actoreventtable} in section \ref{sec:actors}. This function creates a person with characteristics to define him/her in the application.

\paragraph{Rename Person} This is a trivial function, which simply changes the name of a person.

\paragraph{Remove Person} This function removes a person from the application.
