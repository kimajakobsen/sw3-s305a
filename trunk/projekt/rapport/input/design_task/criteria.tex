...
\hline \\
  ...
  Testable&The cost to ensure performs intentionally \\ \\	
	Flexible&How easily the system can be setup to fit the structure of an institution. \\ \\  %Flexible&The cost for the end user to modify the system after deployment \\ \\
...
departments
person management, reset password, new tags and cats, stats, roles
