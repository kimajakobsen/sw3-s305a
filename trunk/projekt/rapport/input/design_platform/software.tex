...
Our system requires a DBMS supporting the query language \sql[] as well as the relational database storage model \fixme{hvad menes der med dette? evt kilde hvis det er en bestem model}.
