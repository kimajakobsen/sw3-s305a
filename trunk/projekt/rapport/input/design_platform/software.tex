...
Our system relies on two things in order to run:
...
Using an external DBMS allows us to access the data from multiple machines, making the system easier to distribute, run, and develop.
