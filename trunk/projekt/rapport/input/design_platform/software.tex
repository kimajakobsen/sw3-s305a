...
The \hdesk requires a DBMS supporting the query language \sql[] and relational database storage model \fixme{hvad menes der med dette? evt kilde hvis det er en bestem model}.
