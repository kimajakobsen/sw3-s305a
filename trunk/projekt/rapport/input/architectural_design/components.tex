...
Our database will be accessed by the system though the ADO.NET data provider. This gives us a component design as seen on figure \ref{fig:system_component_mvc}. 
