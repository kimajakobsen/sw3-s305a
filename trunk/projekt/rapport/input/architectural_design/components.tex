...
To obtain high flexibility we will use ASP.NET Mvc framework. Which is a model view controller design pattern based framework. 
The database will be access by the system though ADO.NET data provider. This give a component design as seen on figure \ref{fig:system_component_mvc}. 
