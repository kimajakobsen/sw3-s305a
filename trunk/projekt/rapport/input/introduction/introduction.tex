...
%This would probably not take more time for the employee because he/she will have to describe the problem anyway in order to get it solved by someone else.
...
Saving solved problems could result in a faster solveing times for problems that reoccur later.
