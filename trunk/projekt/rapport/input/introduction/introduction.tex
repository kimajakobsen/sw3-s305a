...
Orgainzing and solving problems can also be a difficult task for the one who has to solve them. If no systematic approach to organize the problems is applied then redundant work might appear, not just wasting time, but could in the worst case make the original problem worse.\\
