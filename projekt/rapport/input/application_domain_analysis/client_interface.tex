...
\fixme{På billedet med client navigation, skal knappen ``Search for problem(s)'' omdøbes til ``Search for problems''}
...
\subsubsection{Categorize New Problem}\fixme{på billedet med client navigation skal ``Categorize New Problem'' ændres til ``Categorize new problem''}

\subsubsection{Search for similar problems}

\subsubsection{Create new problem}

\subsubsection{Client problem view} \fixme{Client Problem View skal være med småt}
