...
\item \sadb{Functions:} Add comment, reassign, change status, search database, create solution, attach solution and get staff \todolist{}.\fixme{make it right, when the functions are updated.}
\end{itemize}
