...
When an \admin[] enters the administrate-persons window the \admin[] is presented with a list of persons and a ``New Person'' button. From this window the \admin[] can select an existing person and change the data of him or her.
