...
The \cl{StatisticsController} controller -- seen in code snippet \ref{lst:getstatistics} -- calculates the statistics, by utilizing the \me{AveragePerProblem()} method -- seen in code snippet \ref{lst:averageperproblem}. A screenshot can be seen on figure \ref{fig:stat}.
