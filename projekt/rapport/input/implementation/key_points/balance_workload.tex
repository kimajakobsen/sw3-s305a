...
The workload of a staff member is defined by the amount of time that each problem on his workload estimated takes to be solved. 
...
E.g. if there are two staff members it is run once, if there is three it yields twice etc. 
