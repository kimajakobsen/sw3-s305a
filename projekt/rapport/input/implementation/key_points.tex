...
The key points are central functionality from the \hdesk[]. These are chosen because they are central functions to the entire system.
...
\myTail{The key points presented in this chapter are all central functions.}