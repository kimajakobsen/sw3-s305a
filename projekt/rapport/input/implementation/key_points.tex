...
The most complex key points are described thoroughly, while the simpler key points are described more briefly.
...
\input{input/implementation/key_points/distribute_problems}
