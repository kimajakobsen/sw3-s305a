...
\\
After completing a sprint the team demonstrates all the features added to the product. This is done to assure that the customer and the developers are on the same page.\fixme{Mener du den danske tale m\aa de ``er p\aa samme side'', fordi s\aa hedder det same side tror jeg} Of course this meeting might lead to alteration of the recently implememted features, however, it might also lead to more features being added to the product backlog.\\
\\
...
%\fixme{omkrives, lyder af lort}Extreme programming is different from other development methods because it is very hard to define the method within it, it is much more a mythology than it is an actual method, and so the working principles of XP is all recommendations:
