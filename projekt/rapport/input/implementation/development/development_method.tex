...
In this section we will describe a few different Software development methods that we considered using. %Guds nåde tryste den de laver dette ``considered'' om til nutid igen //Lasse
