...
\hline \\
  ...
  Testable&The cost to ensure performs intentionally \\ \\	
	Flexible&How easily the system can be modified to fit the structure of an institution. \\ \\  %Flexible&The cost for the end user to modify the system after deployment \\ \\
