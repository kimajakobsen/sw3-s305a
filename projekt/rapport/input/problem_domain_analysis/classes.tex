...
In the process of finding classes and events we made up several classes and events who are not used in the actual program. This section describes all the classes and events we found. On figure \ref{fig:classeseventstable} 

this is the final iteration

talk to users? we are users!
...
\fixme{slå events sammen, tilføg de nye events, flere classes se klass diagram, fjern urelevante, kald den general, kontroller at checkmarks er sat rigtigt (detpartment)}