...
\pcparagraph{Pros} are that the expected time of completion of solving a problem will be more accurate and the application will more efficiently distribute problems.
\pcparagraph{Cons} are that it requires more administration of the application, as schedules change and employees sometimes are sick or on holiday.
