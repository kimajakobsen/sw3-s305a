...
\pcparagraph{Pros} are that the application allows more specific configuration. 
\pcparagraph{Cons} are the time it takes to implement it.
\pcparagraph{We did not implement this feature because} we realized too late that the functionality was missing, thus we did not have time to implement it.
